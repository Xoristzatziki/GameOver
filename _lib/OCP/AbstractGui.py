...
class OCPAbstractGui(Gtk.Window):
    ...
    def __init__( self, myApp, gladename, otherwidjets = (),parent = None, mainbox=None, savemysettings=None, clearing = None ):
        self.OCPwindow = Gtk.Window.__init__(self, name='windowMain')
        #print(otherwidjets)
        if parent != None:
